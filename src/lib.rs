...
impl Display for GGMLType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            GGMLType::IQ2XSS => write!(f, "IQ2XSS"),
            GGMLType::IQ2XS => write!(f, "IQ2XS"),
            GGMLType::IQ3XSS => write!(f, "IQ3XSS"),
            GGMLType::IQ1S => write!(f, "IQ1S"),
            GGMLType::IQ4NL => write!(f, "IQ4NL"),
            GGMLType::IQ3S => write!(f, "IQ3S"),
            GGMLType::IQ2S => write!(f, "IQ2S"),
            GGMLType::IQ4XS => write!(f, "IQ4XS"),
            GGMLType::I8 => write!(f, "I8"),
            GGMLType::I16 => write!(f, "I16"),
            GGMLType::I32 => write!(f, "I32"),
            GGMLType::I64 => write!(f, "I64"),
            GGMLType::F64 => write!(f, "F64"),
            GGMLType::IQ1M => write!(f, "IQ1M"),
            GGMLType::IQ4XS => write!(f, "IQ4XS"),
    ...
    pub(crate) fn decode(&mut self, mut reader: impl std::io::Read) -> Result<()> {
        ...
        for _ in 0..self.num_tensor() {
            ...
            let type_size = match ggml_type_kind {
                ...
                GGMLType::Q8K => block_size / 2 + block_size / 4 + block_size / 16 + 2,
                GGMLType::IQ2XSS => 2 + block_size / 16 + block_size / 4,
                GGMLType::IQ2XS => 2 + block_size / 16 + block_size / 4,
                GGMLType::IQ3XSS => 2 + block_size / 8 + block_size / 4,
                GGMLType::IQ1S => 2 + block_size / 8 + block_size / 4,
                GGMLType::IQ4NL => 2 + block_size / 8 + block_size / 4,
                GGMLType::IQ3S => 2 + block_size / 8 + block_size / 4,
                GGMLType::IQ2S => 2 + block_size / 8 + block_size / 4,
                GGMLType::IQ4XS => 2 + block_size / 8 + block_size / 4,
                GGMLType::I8 => 1,
                GGMLType::I16 => 2,
                GGMLType::I32 => 4,
                GGMLType::I64 => 8,
                GGMLType::F64 => 8,
                GGMLType::IQ1M => 2 + block_size / 8 + block_size / 4,
                GGMLType::Count => todo!(),
            };
